...
export async function onRequestGet(context) {
  ...
  if (params.get('pigeonsRate') === '1') {
    ...
    return json({ xrpPerPigeon: rate.xrpPerPigeon, usdPerPigeon: rate.usdPerPigeon, marketCapXrp: rate.marketCapXrp, liquidityXrp: rate.liquidityXrp, dexUrl: rate.dexUrl });
  }
